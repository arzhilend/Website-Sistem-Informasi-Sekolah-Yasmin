...
Route::prefix('public')->group(function () {
    ...
    Route::get('/profil', [PublicPageController::class, 'profil']);
    Route::get('/news', [PublicPageController::class, 'news']);
    Route::get('/news/{slug}', [PublicPageController::class, 'newsDetail']);
    Route::get('/prestasi', [PublicPageController::class, 'prestasi']);
    Route::get('/ppdb', [PublicPageController::class, 'ppdb']);
    Route::get('/ppdb/landing', [PublicPageController::class, 'ppdbLanding']);
    Route::get('/guru', [PublicPageController::class, 'guru']);
});
