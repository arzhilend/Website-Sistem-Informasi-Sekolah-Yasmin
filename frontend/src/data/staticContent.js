...
export const staticEkskul = [
  {
    ...
    name: 'Futsal',
    category: 'Olahraga',
    tagline: 'Melatih kekompakan, strategi, dan sportivitas.',
    description:
      'Ekstrakurikuler futsal menjadi ruang bagi siswa untuk mengembangkan kemampuan fisik, disiplin latihan, dan kerja sama tim.',
    image: image('ekstrakurikuler', '1764657650_692e89f2e615d.png'),
    schedule: 'Jumat, 15.30 WIB',
    location: 'Lapangan Sekolah',
    mentor: 'Pembina Olahraga',
    benefits: ['Melatih kerja sama', 'Menjaga kebugaran', 'Membangun mental kompetitif'],
    max_participants: 30,
    available_slots: 12,
  ...
  },
  {
    ...
    category: 'Seni',
    tagline: 'Ruang ekspresi untuk karya, rasa, dan percaya diri.',
    description:
      'Kegiatan seni membantu siswa mengenali potensi kreatif melalui latihan, penampilan, dan proyek karya bersama.',
    image: image('ekstrakurikuler', '1764669117_692eb6bd8f0a6.png'),
    schedule: 'Rabu, 15.30 WIB',
    location: 'Ruang Seni',
    mentor: 'Pembina Seni Budaya',
    benefits: ['Mengasah kreativitas', 'Melatih tampil percaya diri', 'Menguatkan apresiasi budaya'],
    max_participants: 25,
    available_slots: 10,
