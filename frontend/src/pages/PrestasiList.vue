...
const getImageUrl = (path) => {
  ...
  if (path.startsWith('/storage') || path.startsWith('storage/')) return getStorageUrl(path, '/img/placeholder.jpg')

  return getStorageUrl(`prestasi/${path}`, '/img/placeholder.jpg')
}
